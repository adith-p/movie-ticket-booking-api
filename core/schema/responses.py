...
book_show_400 = OpenApiResponse(
    ...
    examples=[
        OpenApiExample(
            "Validation Example",
            value={"detail": "select a valid seat range (0-100)"}
        )
    ]
)
book_show_404 = OpenApiResponse(
    ...
    examples=[
        OpenApiExample(
            "Not Found Example",
            value={"detail": "show with id 123 does not exist"}
        )
    ]
)
book_show_409 = OpenApiResponse(
    ...
    examples=[
        ...
        OpenApiExample(
            "Sold Out",
            summary="Show sold out",
            value={"detail": "sold out!"}
        )
    ]
)
...
cancel_booking_404 = OpenApiResponse(
    ...
    examples=[
        OpenApiExample(
            "Not Found",
            value={"detail": "booking with id 123 does not exist"}
        )
    ]
)
...
cancel_booking_409 = OpenApiResponse(
    ...
    examples=[
        OpenApiExample(
            "Conflict",
            value={"detail": "This booking is already cancelled."}
        )
    ]
)
...
movie_show_404 = OpenApiResponse(
    ...
    examples=[
        OpenApiExample(
            "Not Found Example",
            value={"detail": "Movie with id 123 does not exist"}
        )
    ]
)
